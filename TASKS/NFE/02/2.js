...
Функции – объекты, так что преобразование происходит, как описано в главе Преобразование объектов в примитивы, поэтому можно создать наш собственный метод, возвращающий число. */
/* Решение предложенное в учебнике */
...
function sum0(a) {
  ...
  alert( sum0(1)(2)(3) ); //6
  alert( sum0(5)(-1)(2) );// 6
  alert( sum0(6)(-1)(-2)(-3) ); // 0
  alert( sum0(0)(1)(2)(3)(4)(5) ); // 15
